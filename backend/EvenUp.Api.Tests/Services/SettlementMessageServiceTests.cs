...
public class SettlementMessageServiceTests
{
    ...
    private static SettlementMessageService CreateService(EvenUpDbContext db, AesAccountEncryptionService encryption)
    {
    ...
    private static async Task<SeededScenario> SeedScenarioAsync(EvenUpDbContext db, AesAccountEncryptionService encryption)
    {
