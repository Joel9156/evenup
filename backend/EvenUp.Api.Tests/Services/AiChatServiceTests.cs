...
public class AiChatServiceTests
{
    ...
    private static async Task<SeededGroup> SeedGroupAsync(EvenUpDbContext db)
    {
    ...
    private static async Task<Member> AddCarolAsync(EvenUpDbContext db, Group group)
    {
    ...
    private static async Task<Expense> SeedExpenseAsync(
        EvenUpDbContext db, Group group, Member paidBy, Member createdBy, string description, decimal total, params (Member Member, decimal Amount)[] shares)
    {
