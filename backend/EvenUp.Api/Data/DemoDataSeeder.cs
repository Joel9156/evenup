...
public static class DemoDataSeeder
{
    ...
    public static async Task SeedAsync(EvenUpDbContext db, IPasswordHasher passwordHasher, IAccountEncryptionService accountEncryption, CancellationToken ct = default)
    {
        ...
        {
            Id = Guid.NewGuid(),
            Email = "demo-host@evenup.example",
